...
g++ -I $SYSTEMC_DIR/include -L $SYSTEMC_DIR/lib -Wl,-rpath=$SYSTEMC_DIR/lib64 -std=c++11 -g -o lstm.o lstm_testbench.cc $FLEX_MODEL_DIR/*.o $FLEX_MODEL_UF_DIR/*.o -lsystemc
